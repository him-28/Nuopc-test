module ATM
  ...
  subroutine InitializeP0(gcomp, importState, exportState, clock, rc)
    ...
    if(lPet.eq.0) print *, "Call atm InitializeP0"
...
#define WITHIMPORTFIELDS
    ...
    ! importable field from ocn: sea_surface_temperature
    ...
    ! importable field from ice: surface_downward_x_stress
    call NUOPC_StateAdvertiseField(importState, &
    ...
    ! exportable field to ocn: air_pressure_at_sea_level
    ...
    ! exportable field to ocn: isotropic_shortwave_radiance_in_air
    call NUOPC_StateAdvertiseField(exportState, &
    ...
    ! exportable field to ice: surface_downward_eastward_stress
    call NUOPC_StateAdvertiseField(exportState, &
  ...
  subroutine InitializeP1(gcomp, importState, exportState, clock, rc)
    ...
    CALL ESMF_GridCompGet(gcomp, vm=vm, rc=rc)
    CALL ESMF_VMGet(vm, localPet=lPet,rc=rc)
    if(lPet.eq.0) print *, "Call atm InitializeP1"
