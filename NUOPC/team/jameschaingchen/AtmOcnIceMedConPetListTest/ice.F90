...
!      return  ! bail out
  ...
  subroutine InitializeP0(gcomp, importState, exportState, clock, rc)
    ...
    if(lPet.eq.0) print *, "Call ice InitializeP0"


    ! importable field from atm: surface_downward_eastward_stress 
    ...
    ! importable field from ocn: surface_downward_northward_stress
    call NUOPC_StateAdvertiseField(importState, &
    ...
    ! exportable field to atm: surface_downward_x_stress 
    ...
    ! exportable field to ocn: surface_downward_y_stress
    call NUOPC_StateAdvertiseField(exportState, &
  ...
  subroutine InitializeP1(gcomp, importState, exportState, clock, rc)
    ...
    CALL ESMF_GridCompGet(gcomp, vm=vm, rc=rc)
    CALL ESMF_VMGet(vm, localPet=lPet,rc=rc)
    if(lPet.eq.0) print *, "Call ice InitializeP1"
