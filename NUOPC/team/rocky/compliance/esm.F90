module ESM
  ...
  ! compliance checker
  use NUOPCModel_ComplianceIC, only: registerIC
  ...
  subroutine SetModelServices(driver, rc)
    ...
    ! Explicit registering of NUOPCModel_ComplianceIC for ATM
    !
    ! Need to do handle this outside of user code, preferably
    ! on a per-component basis (i.e., compliance check only a single
