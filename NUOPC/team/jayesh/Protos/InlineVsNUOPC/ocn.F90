module OCN
  ...
  public SetServices, ModelAdvance
...
#define WITHIMPORTFIELDS
  ...
  subroutine InitializeP2(model, importState, exportState, clock, rc)
    ...
    gridIn = ESMF_GridCreateNoPeriDimUfrm(maxIndex=(/64, 64/), &
  ...
  subroutine SetClock(model, rc)
    ...
    call ESMF_TimeIntervalSet(stabilityTimeStep, m=15, rc=rc) ! 5 minute steps
    if (ESMF_LogFoundError(rcToCheck=rc, msg=ESMF_LOGERR_PASSTHRU, &
      line=__LINE__, &
      file=__FILE__)) &
      return  ! bail out
