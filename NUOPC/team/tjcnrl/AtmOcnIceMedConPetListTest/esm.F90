...
#ifdef INCLUDE_ATM
  use ATM,     only: atmLiveSS => SetServices
  use ATM,     only: atmDataSS => SetServices
#endif

#ifdef INCLUDE_OCN
  use OCN,     only: ocnLiveSS => SetServices
  use OCN,     only: ocnDataSS => SetServices
#endif

#ifdef INCLUDE_WAV
  use WAV,     only: wavLiveSS => SetServices
  use WAV,     only: wavDataSS => SetServices
#endif

#ifdef INCLUDE_ICE
  use ICE,     only: iceLiveSS => SetServices
  use ICE,     only: iceDataSS => SetServices
#endif

#ifdef INCLUDE_LND
  use LND,     only: lndLiveSS => SetServices
  use LND,     only: lndDataSS => SetServices
#endif
