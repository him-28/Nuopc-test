...
!      return  ! bail out
  ...
  subroutine InitializeP0(gcomp, importState, exportState, clock, rc)
    ...
    if(lPet.eq.0) print *, "Call ocn InitializeP0"
...
#define WITHIMPORTFIELDS
    ...
    ! importable field from atm: air_pressure_at_sea_level
    ...
    ! importable field from atm: isotropic_shortwave_radiance_in_air
    call NUOPC_StateAdvertiseField(importState, &
    ...
    ! importable field from ice: surface_downward_y_stress 
    call NUOPC_StateAdvertiseField(importState, &
    ...
    ! exportable field to ice: surface_downward_northward_stress
    call NUOPC_StateAdvertiseField(exportState, &
  ...
  subroutine InitializeP1(gcomp, importState, exportState, clock, rc)
    ...
    CALL ESMF_GridCompGet(gcomp, vm=vm, rc=rc)
    CALL ESMF_VMGet(vm, localPet=lPet,rc=rc)
    if(lPet.eq.0) print *, "Call ocn InitializeP1"
